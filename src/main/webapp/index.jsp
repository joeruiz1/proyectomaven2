<%-- 
    Document   : index
    Created on : 23/10/2017, 11:33:06 PM
    Author     : Juan Manuel
--%>
        ...
        <div id="wrapper">
                        ...
                        <div class="navbar">
                            <div class="navbar-inner">
                                <ul class="sf-menu">
                                    ...
                                    <li><a href="FormaPago.jsp"><img src="img/splash_icon3.png" alt="" class="menu_img"><img src="img/splash_icon3_over.png" alt="" class="menu_img_over"><div class="base_text">Facturar</div><div class="num_text">03</div></a></li>
            ...
            <footer>
                <div class="container">
                    ...
                    <p>Miranda  &copy;  2013 &bull; <a href="index-8.html">Privacy Policy</a></p>
                    <p>More <a rel="nofollow" href="http://www.templatemonster.com/category.php?category=0&type=1" target="_blank"> at TemplateMonster.com</a></p>
                </div>
            </footer>
        </div>
